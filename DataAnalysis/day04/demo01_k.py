...
color = np.zeros(closing_prices.size,dtype='U5')
color[:] = 'green'
color[rise] = 'white'
print(ecolor)
#绘制k线  基准位置
mp.bar(datas,closing_prices-opening_prices,0.8,opening_prices,edgecolor=ecolor,
       color=color,zorder=3)
#绘制实体


#绘制影线
mp.vlines(datas,lowest_prices,highest_prices,color=ecolor)

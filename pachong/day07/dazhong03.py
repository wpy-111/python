...
class DaZhongSpider:
    #cookie也会过期
    def __init__(self):
        self.url = 'http://www.dianping.com/shanghai/ch0/p{}'
    ...
    def get_html(self):
        html = requests.get(url=self.url,headers=self.headers,cookies=self.cookies).text
        print(html)
